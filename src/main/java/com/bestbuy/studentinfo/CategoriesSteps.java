...
public class CategoriesSteps {
    ...
    public ValidatableResponse updatingCategory(String categoryID,String name,String id){
    ...
    @Step("Updating Category with ID {0},name: {1}, ID: {2}")
    public ValidatableResponse updatingCategoryRecord (String name,String categoryID){
